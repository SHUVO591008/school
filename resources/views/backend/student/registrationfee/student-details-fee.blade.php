...
<body>
    <div class="panel-body">
        <div class="clearfix">
            ...
            <table class="table border-dark text-center">
                <tr>
                    ...
                    <th>
                        <img style="width: 15%;" src="{{ $std['studentData']['image'] }}">
                    </th>
                </tr>
                    <thead>
                        <tr>
                            <th style="text-align: center;" colspan="3">Student Registration Fee</th>
                        </tr>
                    </thead>
            </table>
        </div>
        <div class="col-md-12">
            <?php
                $registrationFee =  App\model\studentFeeAmount::where('fee_category_id','4')->where('class_id',$std->class_id)->first();
                $originafee = $registrationFee->amount;
                $discount = $std['studentdiscount']['discount'];    
            ...
            <div class="table-responsive">
                <table border="1" class="table border-dark text-center">
                    <tbody>
                        ...
                        <tr>
                            <td style="padding: 4px">Registration Fee</td>
                        ...
                        <tr>
                            <td style="padding: 4px">Fee(This Student)</td>
