                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading">
                                           Manage Employee Salary(Add/Edit)
                                        <a style="float: right" class="btn btn-success" href="{{ route('accounts.employee.salary.view') }}"> <i class="fa fa-list" aria-hidden="true"></i> Employee Salary View </a>
                                        ...
                                        <div class="row">
                                            ...
                                            <script id="document-template" type="text/x-handlebars-template">
                                                ...
                                                <form action="{{ route('accounts.employee.salary.store') }}" method="post">
                                                    @csrf
                                                    <table class="table table-striped table-bordered table-inverse table-responsive" style="width: 100%">
                                                        <thead>
                                                            <tr>
                                                              @{{{thsource}}}
                                                            </tr>
