                                                ...
                                                <form id="myForm">
                                                    ...
                                                    <div style="display: none" class="row" id="marks-generate">
                                                        ...
                                                        <div style="margin-top: 40px; margin-left: 55px;" class="col-md-12 content-top-2">
                                                            <input id="submit" class="btn btn-primary" type="submit" value="Marks Entry"/>
                                                        </div>
                                                    </div>
                                                </form>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data,function( key, v){
                    ...
                    '<td><input type="text" class="form-control" id="marks'+key+'" name="marks[]" value=""></td>'+
                    '</tr>';
                });
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data.error){
                        ...
                        var html = 'Marks Inserted Succesfully.';
                        $('#msg_div').fadeIn();
