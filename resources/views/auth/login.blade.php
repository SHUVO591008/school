            ...
            <div class="login-bottom">
                ...
                <div class="col-md-6">
                    <div class="login-mail">
                        <input type="text" placeholder="Email" name="email" id="email" value="{{ old('email') }}" autocomplete="email"  required="">

                        <i style="float: right" class="fa fa-envelope"></i>
                ...
                <div class="col-md-6 login-do">
                    ...
                    <a href="{{ route('register') }}" class="hvr-shutter-in-horizontal">Signup</a>
                </div>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="content-main">
                ...
                <div id="owl-demo" class="owl-carousel text-center">
                    <div class="item">
                        <img class="lazyOwl img-responsive" data-src="{{asset('images/na.jpg"')}} alt="name">
                    </div>
                    <div class="item">
                        <img class="lazyOwl img-responsive" data-src="{{asset('images/na1.jpg')}}" alt="name">
                    </div>
                    <div class="item">
                        <img class="lazyOwl img-responsive" data-src="{{asset('images/na2.jpg')}}" alt="name">
                    </div>
                    <div class="item">
                        <img class="lazyOwl img-responsive" data-src="{{asset('images/na.jpg')}}" alt="name">
                    </div>
                ...
                <!---->
    <div class="copy">
        <p> &copy; 2020 E-Commerce. All Rights Reserved | Design by SHUVO </p>
    </div>
